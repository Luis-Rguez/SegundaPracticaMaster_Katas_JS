...
const mayoriaEdad = ages.filter((age) => age > 18);
...
const playersLOL = streamers.filter((streamer) => streamer.gameMorePlayed.includes("League of Legends"));
...
const playersWithU = streamers2.filter((streamer) => streamer.name.includes("u"));
...
const newStreamersLeague = streamers.filter((streamer) =>
{
...
console.log(newStreamersLeague);
